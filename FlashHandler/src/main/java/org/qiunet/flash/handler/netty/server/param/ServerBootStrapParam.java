...
public class ServerBootStrapParam {
	 ...
	 * 可以自定义协议头
	 */
	private IProtocolHeaderType protocolHeaderType;
	/***
	 * 客户端每5秒一次心跳
	 * 读超时处理.
	 */
	...
	public class Builder {
		...
		public Builder setProtocolHeaderType(IProtocolHeaderType protocolHeaderType) {
			ServerBootStrapParam.this.protocolHeaderType = protocolHeaderType;
			return this;
		}
